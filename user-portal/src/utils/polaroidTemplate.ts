...
export function createPolaroidTemplate({
  ...
  return `
    <div style="
      ...
      place-items: center;
      background:
        radial-gradient(circle at 20% 10%, rgba(255,255,255,.8), transparent 20%),
        radial-gradient(circle at 80% 20%, rgba(255,210,225,.75), transparent 22%),
