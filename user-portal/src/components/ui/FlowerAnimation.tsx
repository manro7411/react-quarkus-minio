...
export default function FlowersPage({
    ...
    useEffect(() => {
        // Trigger the animation start after component mounts
    ...
    return (
        // We replace the 'body.container' logic with a wrapper div.
        // When 'loaded' is false, we add the 'container' class to pause animations.
        <main className={`main-screen ${!loaded ? 'container' : ''}`}>
            <div className="night"></div>

            <div className="flowers" style={{ transform: `scale(${scale})` }}>
                {/* Flower 1 */}
                ...
                {/* Flower 4 (Added based on HTML structure provided) */}
                ...
                {[
                    ...
                    <div key={g.id} className={`long-g long-g--${g.id}`}>
                        {g.delays.map((d, i) => (
        ...
        *::before {
        ...
        :root {
          --dark-color: ${nightColor};
          --flower-color: ${flowerColor};
        }

        /* Replaced body selector with .main-screen for component isolation */
        .main-screen {
          display: flex;
